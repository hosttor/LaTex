...
\begin{figure}
\centering
\includegraphics[width=220]{images/logo.png}
\end{figure}
\titlepage
...
\item Create one branded newsletter template. Setup three email marketing list that will have an easy signup via the website for news and special offers. At the point of every purchase or inquiry the customer will be prompted to add themselves to this marketing list.
\subsection{DELIVERABLES}
\begin{itemize}
\item 1 Custom email marketing template
\end{itemize}

\section{SOCIAL MEDIA SETUP}
\item We will integrate social media widgets into the site in the appropriate places. Additionally, we will customize your various social media properties to have a consistent look and feel and desired functionality.
\subsection{DELIVERABLES}
\begin{itemize}
\item Facebook commenting on-site
\item Social media links
\item Social sharing ("like" and share buttons)
\item Twitter feed and hashtags for product/service page feeds
\item Facebook tabs for opt-in and products/services
\item Facebook and twitter RSS tie-ins
\item Customize Facebook page icon and cover image
\item Customize Google Plus page
\item Customize Twitter page design
\item Customize Foursquare page icon
\end{itemize}

\section{COMPLETION}
\item Before your website goes live we will do a quality assurance review of each web page to make it meets scope specification. Also, we will help you transfer your DNS to point to your new website. Finally, we will provide a thirty day warranty period from the day the website goes live to make sure the website meets your specifications.
\end{itemize}
...
\begin{table}[ht]
\caption{PROJECT INVESTMENT} % title of Table
\centering % used for centering table
\begin{tabular}{c c c} % centered columns (3 columns)
\hline\hline %inserts double horizontal lines
Deliverable & Timeframe & Cost \\ [0.5ex] % inserts table 
%heading
\hline %inserts single horizontal line
Planning & 1 week & 2,000.00 USD  \\ % inserting body of the table
...
Total & -- & 120,500.00 USD  \\ [1ex] % [1ex] adds vertical space
...
\begin{table}[ht]
\caption{OPTIONAL DELIVERABLES} % title of Table
\centering % used for centering table
...
%heading
\hline %inserts single horizontal line
SEO - Monthly Retainer *Phase begins after site launch & Request Quote  \\ % inserting body of the table
...
Testimonial & Request Quote \\ [1ex] % [1ex] adds vertical space
\hline %inserts single line
...
\begin{tabular}{c c} % centered columns (2 columns)
\hline\hline %inserts double horizontal lines
Hosting Features & Detail \\ [0.5ex] % inserts table 
%heading
\hline %inserts single horizontal line
PACKAGE & Dedicated Server Pro \\ % inserting body of the table
MANAGEMENT TOOLS & Control Panel  \\
STORAGE & 50MB of storage space for all your data \\
BANDWIDTH & 50MB of monthly hosting bandwidth \\
NEWSLETTERS & 50 email newsletters per month \\ [1ex] % [1ex] adds vertical space
\hline %inserts single line
\end{tabular}
\label{table:nonlin} % is used to refer this table in the text
\end{table}
...
\begin{table}[ht]
\caption{INVESTMENT} % title of Table
\centering % used for centering table
\begin{tabular}{c c} % centered columns (2 columns)
\hline\hline %inserts double horizontal lines
Detail & Description \\ [0.5ex] % inserts table 
%heading
\hline %inserts single horizontal line
TERMS & Hosttor offered on a month-to-month basis with no long term contract. \\ % inserting body of the table
RETAINER & Ninety nine dollars and ninety nine cent (250.00 USD) is the ongoing monthly fee for the platform per site. \\ [1ex] % [1ex] adds vertical space
\hline %inserts single line
\end{tabular}
\label{table:nonlin} % is used to refer this table in the text
\end{table}
...
\begin{table}[ht]
\caption{PHONE HELPDESK - Optional} % title of Table
\centering % used for centering table
\begin{tabular}{c c} % centered columns (2 columns)
\hline\hline %inserts double horizontal lines
Detail & Description \\ [0.5ex] % inserts table 
%heading
\hline %inserts single horizontal line
TERMS & One unlimited helpdesk support. Helpdesk does not include design or development labor. \\ % inserting body of the table
RETAINER & 250.00 USD is the ongoing monthly fee for unlimited helpdesk support. \\ [1ex] % [1ex] adds vertical space
\hline %inserts single line
\end{tabular}
\label{table:nonlin} % is used to refer this table in the text
\end{table}
...
\begin{table}[ht]
\caption{PROJECT AGREEMENT} % title of Table
\centering % used for centering table
\begin{tabular}{c c} % centered columns (2 columns)
\hline\hline %inserts double horizontal lines
Hosttor, Inc. & Exanple, Inc. \\ [0.5ex] % inserts table 
%heading
\hline %inserts single horizontal line
71 Commercial Street, Boston, MA 02109 & 123 Light Street, Boston, Massachusetts 02109 \\ % inserting body of the table
Email: sales@hosttor.com & info@example.com
http://hosttor.com & http://example.com \\ [1ex] % [1ex] adds vertical space
\hline %inserts single line
\end{tabular}
\label{table:nonlin} % is used to refer this table in the text
\end{table}
...
\begin{tabular}{c c c} % centered columns (3 columns)
\hline\hline %inserts double horizontal lines
Deliverable & Amount (USD) & Estimated Due Date \\ [0.5ex] % inserts table 
%heading
\hline %inserts single horizontal line
Estimated Due Date & 120,000.00 USD & 01/01/2016 \\ [1ex] % [1ex] adds vertical space
\hline %inserts single line
\end{tabular}
\label{table:nonlin} % is used to refer this table in the text
\end{table}
